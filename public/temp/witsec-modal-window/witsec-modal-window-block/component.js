	...
	mbrApp.loadComponents(
		...
		{"witsec-modal-window-block":{
				...
				_params:{
					...
					modalSize:           { type: "select", title: "Size", values: { small: "Small", medium: "Medium", large: "Large", Xlarge: "Xlarge"},default:"medium",condition:["modalName"]},
